...
type TUploadImageProps = {
  ...
  imagePreviews: string[]; // Change from string to string[]
...
const UploadImage: React.FC<TUploadImageProps> = ({
  ...
  return (
    <div className="w-full flex md:flex-row flex-col gap-10">
      {/* Upload img btn */}
      <div className="w-full md:w-[50%] h-[345px] border border-border-10 rounded-xl flex justify-center items-center overflow-hidden">
