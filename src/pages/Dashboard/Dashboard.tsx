        ...
        <div>
          <div className="w-full  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <StatusCard
              ...
              title="Paid Invoice"
              value={formatNumber(dashboard?.paidInvoices)}
            ...
            <StatusCard
              ...
              value={formatNumber(dashboard?.pendingInvoices)}
            ...
            <StatusCard
              ...
              value={formatNumber(dashboard?.totalPurchaseReceivedFY)}
            ...
            <StatusCard
              ...
              value={formatNumber(dashboard?.totalInvoicesThisMonth)}
            ...
            <StatusCard
              ...
              value={formatNumber(dashboard?.salesThisMonth)}
            ...
            <StatusCard
              ...
              value={formatNumber(dashboard?.purchaseThisMonth)}
